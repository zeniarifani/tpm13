...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/editTeam.css') }}">
</head>
<body>
  ...
  <div id="first-page">
    <div class="website-container">
      ...
      <div class="register-container">
        <p class="informasi-grup">Edit Informasi Grup</p>
          <div class="progress-bar"><img  src="/image/Progress bar 1.png" alt="Progress bar">
          </div>
        
        <form id="register-form1" action="{{ route('update',$team->id)}}" method="post" enctype="multipart/form-data">
          @csrf
          @method('patch')
          <div class="nama-container">
            <label for="nama-group">Edit Nama Group</label>
            <input type="text" name="name" id="nama-group" value="{{ $team->name }}"> 
          ...
          <p class="status-text">Edit Status</p>
            ...
            <script>
                ...
                var binusianStatus = "Binusian"; // Replace this with your actual variable or data

                // Check the appropriate radio button based on the binusianStatus
                if (binusianStatus === "Binusian") {
                    document.getElementById("Binusian").checked = true;
                } else if (binusianStatus === "NonBinusian") {
                    document.getElementById("Non-Binusian").checked = true;
                    }
              </script>
    ...
    <div id="second-page" class="hidden" >
      <div class="website-container">
        ...
        <div class="register-container2">
          <p class="informasi-grup">Edit Informasi Leader</p>
            ...
            <div class="nama-container2">
              ...
              <input type="text" name="leader_name" id="nama-lengkap" > 
      ...
      <div class="website-container">
        ...
        <div class="register-container3">
          ...
          <div class="upload-btn-container">
            <label for="upload-btn">Upload CV</label>
            <input type="file" class="form control" id="upload-btn" name="cv">
      
            <label for="upload-btn">Upload Flazz Card / ID</label>
            <input type="file" class="form control" id="upload-btn" name="id_card">
          </div>
